...
function LinkCard({
  ...
  return (
    <a
      ...
      className='flex items-center p-1 w-full rounded-md hover:scale-105 transition-all bg-gray-100 mb-3 max-w-3xl px-10'
    >
  ...
  return (
    <div className='flex items-center flex-col mx-auto w-full justify-center mt-16 px-8'>
      ...
      <div className='my-8 space-y-4'>
        ...
        <LinkCard
          href={'https://forms.gle/MGk3C14f9AZu1txZ6'}
